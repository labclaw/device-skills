"""pytest configuration for biotek-gen5 tests.

Registers the biotek-gen5 device package under the importable name
'devices.biotek_gen5' so that tests can use standard Python import syntax.
...
_DEVICE_DIR = Path(__file__).parent.parent  # .../devices/biotek-gen5/
...
if _PKG_NAME not in sys.modules:
    ...
    _SUBMODULES = ["models", "adapter", "brain", "processor", "driver"]
