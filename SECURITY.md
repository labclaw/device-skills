...
Please report security issues via [GitHub Security Advisories](https://github.com/labclaw/device-skills/security/advisories/new).
...
- Device skill safety bypass (sending unapproved commands to devices)
...
Device-skills controls physical laboratory hardware. Security vulnerabilities that could result in:
